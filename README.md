...
- [Setup](#setup)
	- [Examples 01](#Usage#Examples 01)
	- [Examples 02](#Usage#Examples 02)
- [Usage](#usage)
...
### Examples 01 
**All images in vault**
- [base file](example-gallary-all-img.base) -as a standalone base file
- [embedded in bote](example-gallary-all-img.md) -as a note

### Example 02
**Images in directories below this notes parent**
- [base file](example-gallary-subdirs.base) - as a standalone base file
- [embedded in note](example-gallary-subdirs.md) - as a note
